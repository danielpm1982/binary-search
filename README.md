# binary-search
A simple iterative and recursive binary search implementation using Java SE

![test1](https://github.com/danielpm1982/binary-search/blob/master/test/test1.png)

![test2](https://github.com/danielpm1982/binary-search/blob/master/test/test2.png)

[**Description of this repository**]<br>
This app simply demonstrates how to implement binary search algorithms in Java, using both iteration and recursion strategies - O(log n) on average and worst-cases.  

For running this app just run the main method of the Test class, using your IDE, or download the zip build file, unzip it and follow the README.txt instructions.
